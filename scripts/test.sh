...
assert 55 "int main() {int foo; foo = 0; i = 1; while(i <= 10) { foo = foo + i; i = i + 1; } return foo; }"
assert 55 "int main() {int foo; foo = 0; i = 1; while(foo < 55) foo = foo + i; return foo; }"
assert 55 "int main() {int foo; int i; foo = 0; for (i = 1; i <= 10; i = i + 1) foo = foo + i; return foo; }"
assert 10 "int main() {int foo; foo = 1; bar = 0; if (foo == 1)  bar = 10; return bar; }"
assert 0 "int main() {int foo; foo = 0; bar = 0; if (foo == 1)  bar = 10; return bar; }"
